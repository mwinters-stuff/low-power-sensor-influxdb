...
extern const char _INFLUX_LINE_TEMPERATURE[] PROGMEM;
extern const char _INFLUX_LINE_VOLTAGE[] PROGMEM;
...
#define INFLUX_LINE_TEMPERATURE FPSTR(_INFLUX_LINE_TEMPERATURE)
#define INFLUX_LINE_VOLTAGE FPSTR(_INFLUX_LINE_VOLTAGE)
